...
modalTrigger.forEach(btn=> {
    ...
    //izmena zna4eniya, 4tobi ne otvlekalo
    ...
    // ispolzuyem klassi dlya sozdaniya karto4ek menyu
    ...
    new MenuCard(
        ...
        'молоко из миндаля, овса, кокоса или гречки, правильное количество белкой за счет тофу и импортных'+
    ...
    const fores = document.querySelectorAll ('form');
    const message = {
